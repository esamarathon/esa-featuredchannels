    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, needle_1.default('post', "https://" + config.address + "/featured_channels?key=" + config.postKey, JSON.stringify({
                            channels: usernames,
                        }), {
                            headers: {
                ...
                case 2:
                    ...
                    nodecg_1.get().log.debug('[FCB] Failed to send channels', err_1);
                    return [3 /*break*/, 3];
